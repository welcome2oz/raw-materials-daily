...
- 뉴스 선정: **여러 허용 매체가 함께 다룬 뉴스일수록 중요**(coverage). 스틸·레진·비철·화공에서 각각 최대 1건, 하루 최대 4건, coverage 2곳 이상을 먼저 고른다(사용자 결정 2026-09-25). 그런 뉴스가 없는 카테고리는 **원재료 구매에 유용한 단독 보도**(생산·설비·투자·수급 전망·규제·관세·공급 계약의 새 사실, 구체적 이름·숫자·결정 포함)로 채우고, 그것도 없으면 뺀다(억지로 채우지 않음, 사용자 결정 2026-09-26)
